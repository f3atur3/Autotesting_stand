"""
Django settings for auto_testing_stand project.
...
INSTALLED_APPS = [
    ...
    'auto_tests.apps.AutoTestsConfig'
]
...
ROOT_URLCONF = 'auto_testing_stand.urls'
...
WSGI_APPLICATION = 'auto_testing_stand.wsgi.application'
